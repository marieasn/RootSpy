//
// File generated by rootcint at Tue Apr  9 17:57:10 2013
...
/* Dialog_SelectTree */
static int G__Dialog_SelectTree_Dict_658_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__Dialog_SelectTree_Dict_658_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__Dialog_SelectTree_Dict_658_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__Dialog_SelectTree_Dict_658_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) Dialog_SelectTree::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Dialog_SelectTree_Dict_658_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Dialog_SelectTree::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Dialog_SelectTree_Dict_658_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) Dialog_SelectTree::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Dialog_SelectTree_Dict_658_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__Dialog_SelectTree_Dict_658_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__Dialog_SelectTree_Dict_658_0_18(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Dialog_SelectTree::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Dialog_SelectTree_Dict_658_0_19(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) Dialog_SelectTree::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Dialog_SelectTree_Dict_658_0_20(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Dialog_SelectTree::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__Dialog_SelectTree_Dict_658_0_21(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__Dialog_SelectTree_Dict_658_0_22(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static void G__setup_memfuncDialog_SelectTree(void) {
   ...
   G__memfunc_setup("Dialog_SelectTree",1695,G__Dialog_SelectTree_Dict_658_0_1, 105, G__get_linked_tagnum(&G__Dialog_SelectTree_DictLN_Dialog_SelectTree), -1, 0, 3, 1, 1, 0, 
"U 'TGWindow' - 10 - p h - 'UInt_t' 0 - w "
"h - 'UInt_t' 0 - h", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DoTimer",692,G__Dialog_SelectTree_Dict_658_0_2, 121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("CloseWindow",1134,(G__InterfaceMethod) NULL,121, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("DoDoubleClickedEntry",1999,G__Dialog_SelectTree_Dict_658_0_4, 121, -1, -1, 0, 2, 1, 1, 0, 
...
"u 'string' - 1 - path u 'vector<string,allocator<string> >' 'vector<string>' 1 - dirs", (char*)NULL, (void*) NULL, 0);
   ...
   G__memfunc_setup("Class",502,G__Dialog_SelectTree_Dict_658_0_10, 85, G__get_linked_tagnum(&G__Dialog_SelectTree_DictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&Dialog_SelectTree::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__Dialog_SelectTree_Dict_658_0_11, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Dialog_SelectTree::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__Dialog_SelectTree_Dict_658_0_12, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&Dialog_SelectTree::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__Dialog_SelectTree_Dict_658_0_13, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&Dialog_SelectTree::Dictionary) ), 0);
   ...
   G__memfunc_setup("StreamerNVirtual",1656,G__Dialog_SelectTree_Dict_658_0_17, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__Dialog_SelectTree_Dict_658_0_18, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Dialog_SelectTree::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__Dialog_SelectTree_Dict_658_0_19, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&Dialog_SelectTree::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__Dialog_SelectTree_Dict_658_0_20, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Dialog_SelectTree::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__Dialog_SelectTree_Dict_658_0_21, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&Dialog_SelectTree::DeclFileLine) ), 0);
   // automatic destructor
   G__memfunc_setup("~Dialog_SelectTree", 1821, G__Dialog_SelectTree_Dict_658_0_22, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
